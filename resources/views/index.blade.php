...
@section('body')
    ...
    <div class="super_container">
                ...
                <div class="row">
                    <div class="col">
                        <div class="header_content d-flex flex-row align-items-center justify-content-start trans_400">
                            <div class="logo"><a href="#">Up<span>Tech</span></a></div>
                            ...
                            <div class="log_reg">
                                <div class="log_reg_content d-flex flex-row align-items-center justify-content-start">
                                    <div class="login log_reg_text"><a href="#">Acesse</a></div>
        ...
        <div class="menu trans_400">
            ...
            <div class="log_reg">
                <div class="log_reg_content d-flex flex-row align-items-center justify-content-end">
                    <div class="login log_reg_text"><a href="#">Acessar</a></div>
                    <div class="register log_reg_text"><a href="#">Registrar</a></div>
                </div>
            </div>
            <nav class="menu_nav">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="home_content text-center">
                                ...
                                <div class="home_text">Você pode encurtar facilmente seus link e ja compartilhar seus links livremente, de maneira rapida e pratica, vamos la?</div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="domain_search_form_container">
                                <form action="#" id="domain_search_form" class="domain_search_form d-flex flex-md-row flex-column align-items-center justify-content-start">
                                    <div class="d-flex flex-row align-items-center justify-content-start">
                                        <input type="text" class="domain_search_input" placeholder="Informe seu link aqui" >
                                    ...
                                    <button onclick="createShortLink();" class="domain_search_button d-flex flex-row align-items-center justify-content-center"><img src="images/search.png" alt="">Search</button>
                                </form>
                            </div>
                        </div>
                    </div>
        ...
        <div class="services">
            <div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="{{ asset('images/services.jpg')}}" data-speed="0.8"></div>
            <div class="container">
                <div class="row">
                    <div class="col magic_fade_in">
                ...
                <div class="row services_row">
                    ...
                    <div class="col-lg-4 service_col magic_fade_in">
                        <div class="service d-flex flex-column align-items-center justify-content-start text-center trans_200">
                            <div class="service_icon"><img class="svg" src="{{ asset('images/icon_4.svg')}}" alt="https://www.flaticon.com/authors/freepik"></div>
                    ...
                    <div class="col-lg-4 service_col magic_fade_in">
                        <div class="service d-flex flex-column align-items-center justify-content-start text-center trans_200">
                            <div class="service_icon"><img class="svg" src="{{ asset('images/icon_5.svg')}}" alt="https://www.flaticon.com/authors/freepik"></div>
            ...
            <div class="container">
                <div class="row row-lg-eq-height">
                    ...
                    <div class="col-lg-6 choice_col magic_fade_in">
                        <div class="choice_image"><img src="{{ asset('images/choice.png')}}" alt=""></div>
                    </div>
                            ...
                            <div class="choice_list">
                                <ul class="d-flex flex-row align-items-start justify-content-between">
                                    <li class="d-flex flex-column align-items-center justify-content-center magic_fade_in">
                                        <div class="choice_icon"><img src="{{ asset('images/icon_7.svg')}}" alt="https://www.flaticon.com/authors/freepik"></div>
                                        <div class="choice_title">Marketing</div>
                                    </li>
                                    <li class="d-flex flex-column align-items-center justify-content-center magic_fade_in">
                                        <div class="choice_icon"><img src="{{ asset('images/icon_8.svg')}}" alt="https://www.flaticon.com/authors/freepik"></div>
                                        <div class="choice_title">Stats</div>
                                    </li>
                                    <li class="d-flex flex-column align-items-center justify-content-center magic_fade_in">
                                        <div class="choice_icon"><img src="{{ asset('images/icon_9.svg')}}" alt="https://www.flaticon.com/authors/freepik"></div>
                                        <div class="choice_title">Servers</div>
                                    </li>
                                    <li class="d-flex flex-column align-items-center justify-content-center magic_fade_in">
                                        <div class="choice_icon"><img src="{{ asset('images/icon_10.svg')}}" alt="https://www.flaticon.com/authors/freepik"></div>
